...
const files = [
  ...
  "supabase/migrations/20260923_answer_hints_stats.sql",
  "supabase/seed.sql",
];
...
const verifySql = [
  ...
  "select column_name from information_schema.columns where table_name = 'classe_programme_couverture' order by 1",
].join(";\n");
