...
export const MISSION_ID = "cm1-emc-vivre-ensemble-01";

/** CM1 / emc — EMC — Sensibilité règle engagement. Phase A standard. */
  ...
  steps: [
    {
      ...
      progress: 0,
      copy: allUniverses({
        title: "Bienvenue : EMC — Sensibilité règle engagement",
        statement: "Dans cette mission de CM1, tu vas travailler : EMC — Sensibilité règle engagement. Lis bien chaque consigne, utilise l’indice si besoin, puis valide.",
    ...
    },
    {
      ...
      copy: {
        football: {
          title: "Lis le jeu",
          statement: "Observe, calcule et décide. Chaque étape te rapproche du but. Objectif : EMC — Sensibilité règle engagement.",
          caption: "Les zones du terrain s’allument.",
        },
        rugby: {
          title: "Observe la défense",
          statement: "Lis les espaces, calcule, puis avance au bon moment. Objectif : EMC — Sensibilité règle engagement.",
          caption: "Les couloirs gauche, axe et large deviennent visibles.",
        },
        equitation: {
          title: "Choisis le chemin",
          statement: "Observe les bornes, calcule, et garde une allure sûre. Objectif : EMC — Sensibilité règle engagement.",
          caption: "Les principaux sentiers s’activent.",
        },
        espace: {
          title: "Rétablis la trajectoire",
          statement: "Analyse les signaux, calcule, et prépare l’arrimage. Objectif : EMC — Sensibilité règle engagement.",
    ...
    },
    {
      ...
      progress: 6,
      copy: allUniverses({
        title: "Je progresse sur : EMC — Sensibilité règle engagement",
    ...
    },
    {
      ...
      copy: allUniverses({
        title: "Ton bilan",
        statement: "Tu as travaillé « EMC — Sensibilité règle engagement » sans note ni classement. Qu’as-tu réussi aujourd’hui ?",
