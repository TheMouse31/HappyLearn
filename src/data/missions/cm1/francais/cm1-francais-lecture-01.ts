...
export const MISSION_ID = "cm1-francais-lecture-01";

/** CM1 / francais — Lecture et compréhension. Phase A standard. */
export const mission = defineMission({
  id: MISSION_ID,
  grade: "cm1",
  subject: "francais",
  title: "Lecture et compréhension en mission",
  blurb: "Une mission CM1 : Lecture et compréhension.",
  available: false,
  version: 1,
  steps: [
    {
      ...
      progress: 0,
      copy: allUniverses({
        title: "Bienvenue : Lecture et compréhension",
        statement: "Dans cette mission de CM1, tu vas travailler : Lecture et compréhension. Lis bien chaque consigne, utilise l’indice si besoin, puis valide.",
    ...
    },
    {
      ...
      copy: {
        football: {
          title: "Lis le jeu",
          statement: "Observe, calcule et décide. Chaque étape te rapproche du but. Objectif : Lecture et compréhension.",
          caption: "Les zones du terrain s’allument.",
        },
        rugby: {
          title: "Observe la défense",
          statement: "Lis les espaces, calcule, puis avance au bon moment. Objectif : Lecture et compréhension.",
          caption: "Les couloirs gauche, axe et large deviennent visibles.",
        },
        equitation: {
          title: "Choisis le chemin",
          statement: "Observe les bornes, calcule, et garde une allure sûre. Objectif : Lecture et compréhension.",
          caption: "Les principaux sentiers s’activent.",
        },
        espace: {
          title: "Rétablis la trajectoire",
          statement: "Analyse les signaux, calcule, et prépare l’arrimage. Objectif : Lecture et compréhension.",
    ...
    },
    {
      ...
      progress: 6,
      copy: allUniverses({
        title: "Je progresse sur : Lecture et compréhension",
    ...
    },
    {
      ...
      copy: allUniverses({
        title: "Ton bilan",
        statement: "Tu as travaillé « Lecture et compréhension » sans note ni classement. Qu’as-tu réussi aujourd’hui ?",
