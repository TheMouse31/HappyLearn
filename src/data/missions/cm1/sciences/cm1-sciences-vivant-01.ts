...
export const MISSION_ID = "cm1-sciences-vivant-01";

/** CM1 / sciences — Sciences — Vivant. Phase A standard. */
  ...
  steps: [
    {
      ...
      copy: allUniverses({
        ...
        statement: "Dans cette mission de CM1, tu vas travailler : Sciences — Vivant. Lis bien chaque consigne, utilise l’indice si besoin, puis valide.",
