...
export const MISSION_ID = "cm1-sciences-matiere-01";

/** CM1 / sciences — Sciences — Matière. Phase A standard. */
export const mission = defineMission({
  id: MISSION_ID,
  grade: "cm1",
  subject: "sciences",
  title: "Matière en mission",
  blurb: "Une mission CM1 : Sciences — Matière.",
  available: true,
  version: 1,
  steps: [
    {
      ...
      copy: allUniverses({
        ...
        statement: "Dans cette mission de CM1, tu vas travailler : Sciences — Matière. Lis bien chaque consigne, utilise l’indice si besoin, puis valide.",
