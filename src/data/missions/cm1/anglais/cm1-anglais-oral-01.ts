...
export const MISSION_ID = "cm1-anglais-oral-01";

/** CM1 / anglais — Anglais — Oral thèmes soi classe. Phase A standard. */
export const mission = defineMission({
  id: MISSION_ID,
  grade: "cm1",
  subject: "anglais",
  title: "Oral thèmes soi classe en mission",
  blurb: "Une mission CM1 : Anglais — Oral thèmes soi classe.",
  available: false,
  version: 1,
  steps: [
    {
      ...
      progress: 0,
      copy: allUniverses({
        title: "Bienvenue : Anglais — Oral thèmes soi classe",
        statement: "Dans cette mission de CM1, tu vas travailler : Anglais — Oral thèmes soi classe. Lis bien chaque consigne, utilise l’indice si besoin, puis valide.",
    ...
    },
    {
      ...
      copy: {
        football: {
          title: "Lis le jeu",
          statement: "Observe, calcule et décide. Chaque étape te rapproche du but. Objectif : Anglais — Oral thèmes soi classe.",
          caption: "Les zones du terrain s’allument.",
        },
        rugby: {
          title: "Observe la défense",
          statement: "Lis les espaces, calcule, puis avance au bon moment. Objectif : Anglais — Oral thèmes soi classe.",
          caption: "Les couloirs gauche, axe et large deviennent visibles.",
        },
        equitation: {
          title: "Choisis le chemin",
          statement: "Observe les bornes, calcule, et garde une allure sûre. Objectif : Anglais — Oral thèmes soi classe.",
          caption: "Les principaux sentiers s’activent.",
        },
        espace: {
          title: "Rétablis la trajectoire",
          statement: "Analyse les signaux, calcule, et prépare l’arrimage. Objectif : Anglais — Oral thèmes soi classe.",
    ...
    },
    {
      ...
      progress: 6,
      copy: allUniverses({
        title: "Je progresse sur : Anglais — Oral thèmes soi classe",
    ...
    },
    {
      ...
      copy: allUniverses({
        title: "Ton bilan",
        statement: "Tu as travaillé « Anglais — Oral thèmes soi classe » sans note ni classement. Qu’as-tu réussi aujourd’hui ?",
