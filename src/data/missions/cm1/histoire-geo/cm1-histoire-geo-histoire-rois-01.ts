...
export const MISSION_ID = "cm1-histoire-geo-histoire-rois-01";

/** CM1 / histoire-geo — Histoire — Le temps des rois. Phase A standard. */
export const mission = defineMission({
  id: MISSION_ID,
  grade: "cm1",
  subject: "histoire-geo",
  title: "Le temps des rois en mission",
  blurb: "Une mission CM1 : Histoire — Le temps des rois.",
  available: true,
  version: 1,
  steps: [
    {
      ...
      progress: 0,
      copy: allUniverses({
        title: "Bienvenue : Histoire — Le temps des rois",
        statement: "Dans cette mission de CM1, tu vas travailler : Histoire — Le temps des rois. Lis bien chaque consigne, utilise l’indice si besoin, puis valide.",
    ...
    },
    {
      ...
      copy: {
        football: {
          title: "Lis le jeu",
          statement: "Observe, calcule et décide. Chaque étape te rapproche du but. Objectif : Histoire — Le temps des rois.",
          caption: "Les zones du terrain s’allument.",
        },
        rugby: {
          title: "Observe la défense",
          statement: "Lis les espaces, calcule, puis avance au bon moment. Objectif : Histoire — Le temps des rois.",
          caption: "Les couloirs gauche, axe et large deviennent visibles.",
        },
        equitation: {
          title: "Choisis le chemin",
          statement: "Observe les bornes, calcule, et garde une allure sûre. Objectif : Histoire — Le temps des rois.",
          caption: "Les principaux sentiers s’activent.",
        },
        espace: {
          title: "Rétablis la trajectoire",
          statement: "Analyse les signaux, calcule, et prépare l’arrimage. Objectif : Histoire — Le temps des rois.",
    ...
    },
    {
      ...
      progress: 6,
      copy: allUniverses({
        title: "Je progresse sur : Histoire — Le temps des rois",
    ...
    },
    {
      ...
      copy: allUniverses({
        title: "Ton bilan",
        statement: "Tu as travaillé « Histoire — Le temps des rois » sans note ni classement. Qu’as-tu réussi aujourd’hui ?",
