...
export const MISSION_ID = "cm2-anglais-oral-01";

/** CM2 / anglais — Anglais — Oral A1+ thèmes quotidiens. Phase A standard. */
export const mission = defineMission({
  id: MISSION_ID,
  grade: "cm2",
  subject: "anglais",
  title: "Oral A1+ thèmes quotidiens en mission",
  blurb: "Une mission CM2 : Anglais — Oral A1+ thèmes quotidiens.",
  available: true,
  version: 1,
  steps: [
    {
      ...
      progress: 0,
      copy: allUniverses({
        title: "Bienvenue : Anglais — Oral A1+ thèmes quotidiens",
        statement: "Dans cette mission de CM2, tu vas travailler : Anglais — Oral A1+ thèmes quotidiens. Lis bien chaque consigne, utilise l’indice si besoin, puis valide.",
    ...
    },
    {
      ...
      copy: {
        football: {
          title: "Lis le jeu",
          statement: "Observe, calcule et décide. Chaque étape te rapproche du but. Objectif : Anglais — Oral A1+ thèmes quotidiens.",
          caption: "Les zones du terrain s’allument.",
        },
        rugby: {
          title: "Observe la défense",
          statement: "Lis les espaces, calcule, puis avance au bon moment. Objectif : Anglais — Oral A1+ thèmes quotidiens.",
          caption: "Les couloirs gauche, axe et large deviennent visibles.",
        },
        equitation: {
          title: "Choisis le chemin",
          statement: "Observe les bornes, calcule, et garde une allure sûre. Objectif : Anglais — Oral A1+ thèmes quotidiens.",
          caption: "Les principaux sentiers s’activent.",
        },
        espace: {
          title: "Rétablis la trajectoire",
          statement: "Analyse les signaux, calcule, et prépare l’arrimage. Objectif : Anglais — Oral A1+ thèmes quotidiens.",
    ...
    },
    {
      ...
      progress: 6,
      copy: allUniverses({
        title: "Je progresse sur : Anglais — Oral A1+ thèmes quotidiens",
    ...
    },
    {
      ...
      copy: allUniverses({
        title: "Ton bilan",
        statement: "Tu as travaillé « Anglais — Oral A1+ thèmes quotidiens » sans note ni classement. Qu’as-tu réussi aujourd’hui ?",
