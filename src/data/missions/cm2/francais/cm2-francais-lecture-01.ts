...
export const MISSION_ID = "cm2-francais-lecture-01";

/** CM2 / francais — Lecture et compréhension. Phase A standard. */
export const mission = defineMission({
  id: MISSION_ID,
  grade: "cm2",
  subject: "francais",
  title: "Lecture et compréhension en mission",
  blurb: "Une mission CM2 : Lecture et compréhension.",
  available: false,
  version: 1,
  steps: [
    {
      ...
      copy: allUniverses({
        ...
        statement: "Dans cette mission de CM2, tu vas travailler : Lecture et compréhension. Lis bien chaque consigne, utilise l’indice si besoin, puis valide.",
