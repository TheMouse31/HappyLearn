...
export const MISSION_ID = "cm2-francais-langue-01";

/** CM2 / francais — Étude de la langue (grammaire orthographe). Phase A standard. */
  ...
  steps: [
    {
      ...
      progress: 0,
      copy: allUniverses({
        title: "Bienvenue : Étude de la langue (grammaire orthographe)",
        statement: "Dans cette mission de CM2, tu vas travailler : Étude de la langue (grammaire orthographe). Lis bien chaque consigne, utilise l’indice si besoin, puis valide.",
    ...
    },
    {
      ...
      copy: {
        football: {
          title: "Lis le jeu",
          statement: "Observe, calcule et décide. Chaque étape te rapproche du but. Objectif : Étude de la langue (grammaire orthographe).",
          caption: "Les zones du terrain s’allument.",
        },
        rugby: {
          title: "Observe la défense",
          statement: "Lis les espaces, calcule, puis avance au bon moment. Objectif : Étude de la langue (grammaire orthographe).",
          caption: "Les couloirs gauche, axe et large deviennent visibles.",
        },
        equitation: {
          title: "Choisis le chemin",
          statement: "Observe les bornes, calcule, et garde une allure sûre. Objectif : Étude de la langue (grammaire orthographe).",
          caption: "Les principaux sentiers s’activent.",
        },
        espace: {
          title: "Rétablis la trajectoire",
          statement: "Analyse les signaux, calcule, et prépare l’arrimage. Objectif : Étude de la langue (grammaire orthographe).",
    ...
    },
    {
      ...
      progress: 6,
      copy: allUniverses({
        title: "Je progresse sur : Étude de la langue (grammaire orthographe)",
    ...
    },
    {
      ...
      copy: allUniverses({
        title: "Ton bilan",
        statement: "Tu as travaillé « Étude de la langue (grammaire orthographe) » sans note ni classement. Qu’as-tu réussi aujourd’hui ?",
