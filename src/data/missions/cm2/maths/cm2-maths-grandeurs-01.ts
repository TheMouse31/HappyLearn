...
export const MISSION_ID = "cm2-maths-grandeurs-01";

/** CM2 / maths — Grandeurs et mesures (durées angles aires). Phase A standard. */
  ...
  steps: [
    {
      ...
      progress: 0,
      copy: allUniverses({
        title: "Bienvenue : Grandeurs et mesures (durées angles aires)",
        statement: "Dans cette mission de CM2, tu vas travailler : Grandeurs et mesures (durées angles aires). Lis bien chaque consigne, utilise l’indice si besoin, puis valide.",
    ...
    },
    {
      ...
      copy: {
        football: {
          title: "Lis le jeu",
          statement: "Observe, calcule et décide. Chaque étape te rapproche du but. Objectif : Grandeurs et mesures (durées angles aires).",
          caption: "Les zones du terrain s’allument.",
        },
        rugby: {
          title: "Observe la défense",
          statement: "Lis les espaces, calcule, puis avance au bon moment. Objectif : Grandeurs et mesures (durées angles aires).",
          caption: "Les couloirs gauche, axe et large deviennent visibles.",
        },
        equitation: {
          title: "Choisis le chemin",
          statement: "Observe les bornes, calcule, et garde une allure sûre. Objectif : Grandeurs et mesures (durées angles aires).",
          caption: "Les principaux sentiers s’activent.",
        },
        espace: {
          title: "Rétablis la trajectoire",
          statement: "Analyse les signaux, calcule, et prépare l’arrimage. Objectif : Grandeurs et mesures (durées angles aires).",
    ...
    {
      kind: "number",
      kicker: "Étape 1 sur 6 · Durée",
      progress: 1,
      expected: "60",
      distractors: ["30", "100"],
      copy: allUniverses({
        title: "Minutes dans 1 h",
        statement: "Combien de minutes dans 1 heure ?",
        hint: "60.",
    ...
    },
    {
      ...
      copy: {
        football: {
          title: "1 h 30",
          statement: "1 h 30 min = combien de minutes ?",
          hint: "90.",
          caption: "Les zones du terrain s’allument.",
        },
        rugby: {
    ...
    {
      kind: "number",
      kicker: "Étape 3 sur 6 · Angle",
      progress: 3,
      expected: "90",
      distractors: ["45", "180"],
      copy: allUniverses({
        title: "Angle droit",
        statement: "Combien de degrés dans un angle droit ?",
        hint: "90.",
        caption: "Tu valides ta réponse.",
      }),
    },
    {
      kind: "choice",
      kicker: "Étape 4 sur 6 · Unité",
      progress: 4,
      expected: "mètre",
      distractors: ["gramme", "litre"],
      copy: {
        football: {
          title: "Longueur",
          statement: "Quelle unité pour une longueur de terrain ?",
          hint: "mètre.",
          caption: "Les zones du terrain s’allument.",
        },
        rugby: {
    ...
    {
      kind: "number",
      kicker: "Étape 5 sur 6 · Périmètre",
      progress: 5,
      expected: "20",
      distractors: ["16", "24"],
      copy: allUniverses({
        title: "Carré côté 5",
        statement: "Périmètre d’un carré de côté 5 ?",
        hint: "4×5=20.",
        caption: "Tu valides ta réponse.",
      }),
    },
    {
      kind: "number",
      kicker: "Étape 6 sur 6 · Conversion",
      progress: 6,
      expected: "1000",
      distractors: ["100", "10"],
      copy: {
    ...
    },
    {
      ...
      copy: {
        football: {
          title: "3/4 d’heure",
          statement: "Les 3/4 d’une heure en minutes ?",
          hint: "45.",
          caption: "Les zones du terrain s’allument.",
        },
        rugby: {
    ...
    },
    {
      ...
      progress: 6,
      copy: allUniverses({
        title: "Je progresse sur : Grandeurs et mesures (durées angles aires)",
    ...
    },
    {
      ...
      copy: allUniverses({
        title: "Ton bilan",
        statement: "Tu as travaillé « Grandeurs et mesures (durées angles aires) » sans note ni classement. Qu’as-tu réussi aujourd’hui ?",
