...
export const MISSION_ID = "cm2-maths-geometrie-01";

/** CM2 / maths — Espace et géométrie (figures symétrie). Phase A standard. */
  ...
  steps: [
    {
      ...
      progress: 0,
      copy: allUniverses({
        title: "Bienvenue : Espace et géométrie (figures symétrie)",
        statement: "Dans cette mission de CM2, tu vas travailler : Espace et géométrie (figures symétrie). Lis bien chaque consigne, utilise l’indice si besoin, puis valide.",
    ...
    },
    {
      ...
      copy: {
        football: {
          title: "Lis le jeu",
          statement: "Observe, calcule et décide. Chaque étape te rapproche du but. Objectif : Espace et géométrie (figures symétrie).",
          caption: "Les zones du terrain s’allument.",
        },
        rugby: {
          title: "Observe la défense",
          statement: "Lis les espaces, calcule, puis avance au bon moment. Objectif : Espace et géométrie (figures symétrie).",
          caption: "Les couloirs gauche, axe et large deviennent visibles.",
        },
        equitation: {
          title: "Choisis le chemin",
          statement: "Observe les bornes, calcule, et garde une allure sûre. Objectif : Espace et géométrie (figures symétrie).",
          caption: "Les principaux sentiers s’activent.",
        },
        espace: {
          title: "Rétablis la trajectoire",
          statement: "Analyse les signaux, calcule, et prépare l’arrimage. Objectif : Espace et géométrie (figures symétrie).",
    ...
    },
    {
      ...
      progress: 6,
      copy: allUniverses({
        title: "Je progresse sur : Espace et géométrie (figures symétrie)",
    ...
    },
    {
      ...
      copy: allUniverses({
        title: "Ton bilan",
        statement: "Tu as travaillé « Espace et géométrie (figures symétrie) » sans note ni classement. Qu’as-tu réussi aujourd’hui ?",
