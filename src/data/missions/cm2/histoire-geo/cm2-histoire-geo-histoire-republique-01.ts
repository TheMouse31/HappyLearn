...
export const MISSION_ID = "cm2-histoire-geo-histoire-republique-01";

/** CM2 / histoire-geo — Histoire — Le temps de la République. Phase A standard. */
export const mission = defineMission({
  id: MISSION_ID,
  grade: "cm2",
  subject: "histoire-geo",
  title: "Le temps de la République en mission",
  blurb: "Une mission CM2 : Histoire — Le temps de la République.",
  available: false,
  version: 1,
  steps: [
    {
      ...
      progress: 0,
      copy: allUniverses({
        title: "Bienvenue : Histoire — Le temps de la République",
        statement: "Dans cette mission de CM2, tu vas travailler : Histoire — Le temps de la République. Lis bien chaque consigne, utilise l’indice si besoin, puis valide.",
    ...
    },
    {
      ...
      copy: {
        football: {
          title: "Lis le jeu",
          statement: "Observe, calcule et décide. Chaque étape te rapproche du but. Objectif : Histoire — Le temps de la République.",
          caption: "Les zones du terrain s’allument.",
        },
        rugby: {
          title: "Observe la défense",
          statement: "Lis les espaces, calcule, puis avance au bon moment. Objectif : Histoire — Le temps de la République.",
          caption: "Les couloirs gauche, axe et large deviennent visibles.",
        },
        equitation: {
          title: "Choisis le chemin",
          statement: "Observe les bornes, calcule, et garde une allure sûre. Objectif : Histoire — Le temps de la République.",
          caption: "Les principaux sentiers s’activent.",
        },
        espace: {
          title: "Rétablis la trajectoire",
          statement: "Analyse les signaux, calcule, et prépare l’arrimage. Objectif : Histoire — Le temps de la République.",
    ...
    },
    {
      ...
      progress: 6,
      copy: allUniverses({
        title: "Je progresse sur : Histoire — Le temps de la République",
    ...
    },
    {
      ...
      copy: allUniverses({
        title: "Ton bilan",
        statement: "Tu as travaillé « Histoire — Le temps de la République » sans note ni classement. Qu’as-tu réussi aujourd’hui ?",
