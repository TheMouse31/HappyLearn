...
export const MISSION_ID = "cm2-histoire-geo-histoire-guerres-ue-01";

/** CM2 / histoire-geo — Histoire — Guerres mondiales à l'UE. Phase A standard. */
export const mission = defineMission({
  id: MISSION_ID,
  grade: "cm2",
  subject: "histoire-geo",
  title: "Guerres mondiales à l'UE en mission",
  blurb: "Une mission CM2 : Histoire — Guerres mondiales à l'UE.",
  available: false,
  version: 1,
  steps: [
    {
      ...
      progress: 0,
      copy: allUniverses({
        title: "Bienvenue : Histoire — Guerres mondiales à l'UE",
        statement: "Dans cette mission de CM2, tu vas travailler : Histoire — Guerres mondiales à l'UE. Lis bien chaque consigne, utilise l’indice si besoin, puis valide.",
    ...
    },
    {
      ...
      copy: {
        football: {
          title: "Lis le jeu",
          statement: "Observe, calcule et décide. Chaque étape te rapproche du but. Objectif : Histoire — Guerres mondiales à l'UE.",
          caption: "Les zones du terrain s’allument.",
        },
        rugby: {
          title: "Observe la défense",
          statement: "Lis les espaces, calcule, puis avance au bon moment. Objectif : Histoire — Guerres mondiales à l'UE.",
          caption: "Les couloirs gauche, axe et large deviennent visibles.",
        },
        equitation: {
          title: "Choisis le chemin",
          statement: "Observe les bornes, calcule, et garde une allure sûre. Objectif : Histoire — Guerres mondiales à l'UE.",
          caption: "Les principaux sentiers s’activent.",
        },
        espace: {
          title: "Rétablis la trajectoire",
          statement: "Analyse les signaux, calcule, et prépare l’arrimage. Objectif : Histoire — Guerres mondiales à l'UE.",
    ...
    },
    {
      ...
      progress: 6,
      copy: allUniverses({
        title: "Je progresse sur : Histoire — Guerres mondiales à l'UE",
    ...
    },
    {
      ...
      copy: allUniverses({
        title: "Ton bilan",
        statement: "Tu as travaillé « Histoire — Guerres mondiales à l'UE » sans note ni classement. Qu’as-tu réussi aujourd’hui ?",
