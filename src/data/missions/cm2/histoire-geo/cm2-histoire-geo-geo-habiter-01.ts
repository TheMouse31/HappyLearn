...
export const MISSION_ID = "cm2-histoire-geo-geo-habiter-01";

/** CM2 / histoire-geo — Géographie — Mieux habiter. Phase A standard. */
export const mission = defineMission({
  id: MISSION_ID,
  grade: "cm2",
  subject: "histoire-geo",
  title: "Mieux habiter en mission",
  blurb: "Une mission CM2 : Géographie — Mieux habiter.",
  available: true,
  version: 1,
  steps: [
    {
      ...
      progress: 0,
      copy: allUniverses({
        title: "Bienvenue : Géographie — Mieux habiter",
        statement: "Dans cette mission de CM2, tu vas travailler : Géographie — Mieux habiter. Lis bien chaque consigne, utilise l’indice si besoin, puis valide.",
    ...
    },
    {
      ...
      copy: {
        football: {
          title: "Lis le jeu",
          statement: "Observe, calcule et décide. Chaque étape te rapproche du but. Objectif : Géographie — Mieux habiter.",
          caption: "Les zones du terrain s’allument.",
        },
        rugby: {
          title: "Observe la défense",
          statement: "Lis les espaces, calcule, puis avance au bon moment. Objectif : Géographie — Mieux habiter.",
          caption: "Les couloirs gauche, axe et large deviennent visibles.",
        },
        equitation: {
          title: "Choisis le chemin",
          statement: "Observe les bornes, calcule, et garde une allure sûre. Objectif : Géographie — Mieux habiter.",
          caption: "Les principaux sentiers s’activent.",
        },
        espace: {
          title: "Rétablis la trajectoire",
          statement: "Analyse les signaux, calcule, et prépare l’arrimage. Objectif : Géographie — Mieux habiter.",
    ...
    },
    {
      ...
      progress: 6,
      copy: allUniverses({
        title: "Je progresse sur : Géographie — Mieux habiter",
    ...
    },
    {
      ...
      copy: allUniverses({
        title: "Ton bilan",
        statement: "Tu as travaillé « Géographie — Mieux habiter » sans note ni classement. Qu’as-tu réussi aujourd’hui ?",
