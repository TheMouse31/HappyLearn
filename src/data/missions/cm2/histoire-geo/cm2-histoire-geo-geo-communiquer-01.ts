...
export const MISSION_ID = "cm2-histoire-geo-geo-communiquer-01";

/** CM2 / histoire-geo — Géographie — Communiquer (internet). Phase A standard. */
  ...
  steps: [
    {
      ...
      progress: 0,
      copy: allUniverses({
        title: "Bienvenue : Géographie — Communiquer (internet)",
        statement: "Dans cette mission de CM2, tu vas travailler : Géographie — Communiquer (internet). Lis bien chaque consigne, utilise l’indice si besoin, puis valide.",
    ...
    },
    {
      ...
      copy: {
        football: {
          title: "Lis le jeu",
          statement: "Observe, calcule et décide. Chaque étape te rapproche du but. Objectif : Géographie — Communiquer (internet).",
          caption: "Les zones du terrain s’allument.",
        },
        rugby: {
          title: "Observe la défense",
          statement: "Lis les espaces, calcule, puis avance au bon moment. Objectif : Géographie — Communiquer (internet).",
          caption: "Les couloirs gauche, axe et large deviennent visibles.",
        },
        equitation: {
          title: "Choisis le chemin",
          statement: "Observe les bornes, calcule, et garde une allure sûre. Objectif : Géographie — Communiquer (internet).",
          caption: "Les principaux sentiers s’activent.",
        },
        espace: {
          title: "Rétablis la trajectoire",
          statement: "Analyse les signaux, calcule, et prépare l’arrimage. Objectif : Géographie — Communiquer (internet).",
    ...
    },
    {
      ...
      progress: 6,
      copy: allUniverses({
        title: "Je progresse sur : Géographie — Communiquer (internet)",
    ...
    },
    {
      ...
      copy: allUniverses({
        title: "Ton bilan",
        statement: "Tu as travaillé « Géographie — Communiquer (internet) » sans note ni classement. Qu’as-tu réussi aujourd’hui ?",
