...
export const MISSION_ID = "ce1-emc-vivre-ensemble-01";

/** CE1 / emc — EMC — Vivre ensemble. Phase A standard. */
export const mission = defineMission({
  id: MISSION_ID,
  grade: "ce1",
  subject: "emc",
  title: "Vivre ensemble en mission",
  blurb: "Une mission CE1 : EMC — Vivre ensemble.",
  available: false,
  version: 1,
  steps: [
    {
      ...
      progress: 0,
      copy: allUniverses({
        title: "Bienvenue : EMC — Vivre ensemble",
        statement: "Dans cette mission de CE1, tu vas travailler : EMC — Vivre ensemble. Lis bien chaque consigne, utilise l’indice si besoin, puis valide.",
    ...
    },
    {
      ...
      copy: {
        football: {
          title: "Lis le jeu",
          statement: "Observe, calcule et décide. Chaque étape te rapproche du but. Objectif : EMC — Vivre ensemble.",
          caption: "Les zones du terrain s’allument.",
        },
        rugby: {
          title: "Observe la défense",
          statement: "Lis les espaces, calcule, puis avance au bon moment. Objectif : EMC — Vivre ensemble.",
          caption: "Les couloirs gauche, axe et large deviennent visibles.",
        },
        equitation: {
          title: "Choisis le chemin",
          statement: "Observe les bornes, calcule, et garde une allure sûre. Objectif : EMC — Vivre ensemble.",
          caption: "Les principaux sentiers s’activent.",
        },
        espace: {
          title: "Rétablis la trajectoire",
          statement: "Analyse les signaux, calcule, et prépare l’arrimage. Objectif : EMC — Vivre ensemble.",
    ...
    },
    {
      ...
      progress: 6,
      copy: allUniverses({
        title: "Je progresse sur : EMC — Vivre ensemble",
    ...
    },
    {
      ...
      copy: allUniverses({
        title: "Ton bilan",
        statement: "Tu as travaillé « EMC — Vivre ensemble » sans note ni classement. Qu’as-tu réussi aujourd’hui ?",
