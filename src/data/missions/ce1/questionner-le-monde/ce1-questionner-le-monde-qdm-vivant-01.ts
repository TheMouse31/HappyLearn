...
export const MISSION_ID = "ce1-questionner-le-monde-qdm-vivant-01";

/** CE1 / questionner-le-monde — Questionner le monde — Vivant. Phase A standard. */
  ...
  steps: [
    {
      ...
      copy: allUniverses({
        ...
        statement: "Dans cette mission de CE1, tu vas travailler : Questionner le monde — Vivant. Lis bien chaque consigne, utilise l’indice si besoin, puis valide.",
