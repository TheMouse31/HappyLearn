...
export const MISSION_ID = "ce1-questionner-le-monde-qdm-matiere-objets-01";

/** CE1 / questionner-le-monde — Questionner le monde — Matière et objets. Phase A standard. */
export const mission = defineMission({
  id: MISSION_ID,
  grade: "ce1",
  subject: "questionner-le-monde",
  title: "Matière et objets en mission",
  blurb: "Une mission CE1 : Questionner le monde — Matière et objets.",
  available: false,
  version: 1,
  steps: [
    {
      ...
      progress: 0,
      copy: allUniverses({
        title: "Bienvenue : Questionner le monde — Matière et objets",
        statement: "Dans cette mission de CE1, tu vas travailler : Questionner le monde — Matière et objets. Lis bien chaque consigne, utilise l’indice si besoin, puis valide.",
    ...
    },
    {
      ...
      copy: {
        football: {
          title: "Lis le jeu",
          statement: "Observe, calcule et décide. Chaque étape te rapproche du but. Objectif : Questionner le monde — Matière et objets.",
          caption: "Les zones du terrain s’allument.",
        },
        rugby: {
          title: "Observe la défense",
          statement: "Lis les espaces, calcule, puis avance au bon moment. Objectif : Questionner le monde — Matière et objets.",
          caption: "Les couloirs gauche, axe et large deviennent visibles.",
        },
        equitation: {
          title: "Choisis le chemin",
          statement: "Observe les bornes, calcule, et garde une allure sûre. Objectif : Questionner le monde — Matière et objets.",
          caption: "Les principaux sentiers s’activent.",
        },
        espace: {
          title: "Rétablis la trajectoire",
          statement: "Analyse les signaux, calcule, et prépare l’arrimage. Objectif : Questionner le monde — Matière et objets.",
    ...
    },
    {
      ...
      progress: 6,
      copy: allUniverses({
        title: "Je progresse sur : Questionner le monde — Matière et objets",
    ...
    },
    {
      ...
      copy: allUniverses({
        title: "Ton bilan",
        statement: "Tu as travaillé « Questionner le monde — Matière et objets » sans note ni classement. Qu’as-tu réussi aujourd’hui ?",
