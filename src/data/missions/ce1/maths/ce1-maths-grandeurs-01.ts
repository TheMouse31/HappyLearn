...
export const MISSION_ID = "ce1-maths-grandeurs-01";

/** CE1 / maths — Grandeurs (km masses monnaie centimes). Phase A standard. */
  ...
  steps: [
    {
      ...
      progress: 0,
      copy: allUniverses({
        title: "Bienvenue : Grandeurs (km masses monnaie centimes)",
        statement: "Dans cette mission de CE1, tu vas travailler : Grandeurs (km masses monnaie centimes). Lis bien chaque consigne, utilise l’indice si besoin, puis valide.",
    ...
    },
    {
      ...
      copy: {
        football: {
          title: "Lis le jeu",
          statement: "Observe, calcule et décide. Chaque étape te rapproche du but. Objectif : Grandeurs (km masses monnaie centimes).",
          caption: "Les zones du terrain s’allument.",
        },
        rugby: {
          title: "Observe la défense",
          statement: "Lis les espaces, calcule, puis avance au bon moment. Objectif : Grandeurs (km masses monnaie centimes).",
          caption: "Les couloirs gauche, axe et large deviennent visibles.",
        },
        equitation: {
          title: "Choisis le chemin",
          statement: "Observe les bornes, calcule, et garde une allure sûre. Objectif : Grandeurs (km masses monnaie centimes).",
          caption: "Les principaux sentiers s’activent.",
        },
        espace: {
          title: "Rétablis la trajectoire",
          statement: "Analyse les signaux, calcule, et prépare l’arrimage. Objectif : Grandeurs (km masses monnaie centimes).",
    ...
    },
    {
      ...
      progress: 6,
      copy: allUniverses({
        title: "Je progresse sur : Grandeurs (km masses monnaie centimes)",
    ...
    },
    {
      ...
      copy: allUniverses({
        title: "Ton bilan",
        statement: "Tu as travaillé « Grandeurs (km masses monnaie centimes) » sans note ni classement. Qu’as-tu réussi aujourd’hui ?",
