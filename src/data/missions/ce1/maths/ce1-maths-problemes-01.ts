...
export const MISSION_ID = "ce1-maths-problemes-01";

/** CE1 / maths — Problèmes 1–2 étapes. Phase A standard. */
export const mission = defineMission({
  id: MISSION_ID,
  grade: "ce1",
  subject: "maths",
  title: "Problèmes 1–2 étapes en mission",
  blurb: "Une mission CE1 : Problèmes 1–2 étapes.",
  available: false,
  version: 1,
  steps: [
    {
      ...
      progress: 0,
      copy: allUniverses({
        title: "Bienvenue : Problèmes 1–2 étapes",
        statement: "Dans cette mission de CE1, tu vas travailler : Problèmes 1–2 étapes. Lis bien chaque consigne, utilise l’indice si besoin, puis valide.",
    ...
    },
    {
      ...
      copy: {
        football: {
          title: "Lis le jeu",
          statement: "Observe, calcule et décide. Chaque étape te rapproche du but. Objectif : Problèmes 1–2 étapes.",
          caption: "Les zones du terrain s’allument.",
        },
        rugby: {
          title: "Observe la défense",
          statement: "Lis les espaces, calcule, puis avance au bon moment. Objectif : Problèmes 1–2 étapes.",
          caption: "Les couloirs gauche, axe et large deviennent visibles.",
        },
        equitation: {
          title: "Choisis le chemin",
          statement: "Observe les bornes, calcule, et garde une allure sûre. Objectif : Problèmes 1–2 étapes.",
          caption: "Les principaux sentiers s’activent.",
        },
        espace: {
          title: "Rétablis la trajectoire",
          statement: "Analyse les signaux, calcule, et prépare l’arrimage. Objectif : Problèmes 1–2 étapes.",
    ...
    },
    {
      ...
      progress: 6,
      copy: allUniverses({
        title: "Je progresse sur : Problèmes 1–2 étapes",
    ...
    },
    {
      ...
      copy: allUniverses({
        title: "Ton bilan",
        statement: "Tu as travaillé « Problèmes 1–2 étapes » sans note ni classement. Qu’as-tu réussi aujourd’hui ?",
