...
export const MISSION_ID = "ce1-francais-lecture-01";

/** CE1 / francais — Lecture automatisation compréhension. Phase A standard. */
export const mission = defineMission({
  id: MISSION_ID,
  grade: "ce1",
  subject: "francais",
  title: "Lecture automatisation compréhension en mission",
  blurb: "Une mission CE1 : Lecture automatisation compréhension.",
  available: true,
  version: 1,
  steps: [
    {
      ...
      progress: 0,
      copy: allUniverses({
        title: "Bienvenue : Lecture automatisation compréhension",
        statement: "Dans cette mission de CE1, tu vas travailler : Lecture automatisation compréhension. Lis bien chaque consigne, utilise l’indice si besoin, puis valide.",
    ...
    },
    {
      ...
      copy: {
        football: {
          title: "Lis le jeu",
          statement: "Observe, calcule et décide. Chaque étape te rapproche du but. Objectif : Lecture automatisation compréhension.",
          caption: "Les zones du terrain s’allument.",
        },
        rugby: {
          title: "Observe la défense",
          statement: "Lis les espaces, calcule, puis avance au bon moment. Objectif : Lecture automatisation compréhension.",
          caption: "Les couloirs gauche, axe et large deviennent visibles.",
        },
        equitation: {
          title: "Choisis le chemin",
          statement: "Observe les bornes, calcule, et garde une allure sûre. Objectif : Lecture automatisation compréhension.",
          caption: "Les principaux sentiers s’activent.",
        },
        espace: {
          title: "Rétablis la trajectoire",
          statement: "Analyse les signaux, calcule, et prépare l’arrimage. Objectif : Lecture automatisation compréhension.",
    ...
    },
    {
      ...
      progress: 6,
      copy: allUniverses({
        title: "Je progresse sur : Lecture automatisation compréhension",
    ...
    },
    {
      ...
      copy: allUniverses({
        title: "Ton bilan",
        statement: "Tu as travaillé « Lecture automatisation compréhension » sans note ni classement. Qu’as-tu réussi aujourd’hui ?",
