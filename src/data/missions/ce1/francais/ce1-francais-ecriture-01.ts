...
export const MISSION_ID = "ce1-francais-ecriture-01";

/** CE1 / francais — Écriture phrases et textes courts. Phase A standard. */
export const mission = defineMission({
  id: MISSION_ID,
  grade: "ce1",
  subject: "francais",
  title: "Écriture phrases et textes courts en mission",
  blurb: "Une mission CE1 : Écriture phrases et textes courts.",
  available: true,
  version: 1,
  steps: [
    {
      ...
      progress: 0,
      copy: allUniverses({
        title: "Bienvenue : Écriture phrases et textes courts",
        statement: "Dans cette mission de CE1, tu vas travailler : Écriture phrases et textes courts. Lis bien chaque consigne, utilise l’indice si besoin, puis valide.",
    ...
    },
    {
      ...
      copy: {
        football: {
          title: "Lis le jeu",
          statement: "Observe, calcule et décide. Chaque étape te rapproche du but. Objectif : Écriture phrases et textes courts.",
          caption: "Les zones du terrain s’allument.",
        },
        rugby: {
          title: "Observe la défense",
          statement: "Lis les espaces, calcule, puis avance au bon moment. Objectif : Écriture phrases et textes courts.",
          caption: "Les couloirs gauche, axe et large deviennent visibles.",
        },
        equitation: {
          title: "Choisis le chemin",
          statement: "Observe les bornes, calcule, et garde une allure sûre. Objectif : Écriture phrases et textes courts.",
          caption: "Les principaux sentiers s’activent.",
        },
        espace: {
          title: "Rétablis la trajectoire",
          statement: "Analyse les signaux, calcule, et prépare l’arrimage. Objectif : Écriture phrases et textes courts.",
    ...
    },
    {
      ...
      progress: 6,
      copy: allUniverses({
        title: "Je progresse sur : Écriture phrases et textes courts",
    ...
    },
    {
      ...
      copy: allUniverses({
        title: "Ton bilan",
        statement: "Tu as travaillé « Écriture phrases et textes courts » sans note ni classement. Qu’as-tu réussi aujourd’hui ?",
