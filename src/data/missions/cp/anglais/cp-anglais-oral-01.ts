...
export const MISSION_ID = "cp-anglais-oral-01";

/** CP / anglais — Anglais — Éveil oral A1. Phase A standard. */
export const mission = defineMission({
  id: MISSION_ID,
  grade: "cp",
  subject: "anglais",
  title: "Éveil oral A1 en mission",
  blurb: "Une mission CP : Anglais — Éveil oral A1.",
  available: false,
  version: 1,
  steps: [
    {
      ...
      progress: 0,
      copy: allUniverses({
        title: "Bienvenue : Anglais — Éveil oral A1",
        statement: "Dans cette mission de CP, tu vas travailler : Anglais — Éveil oral A1. Lis bien chaque consigne, utilise l’indice si besoin, puis valide.",
    ...
    },
    {
      ...
      copy: {
        football: {
          title: "Lis le jeu",
          statement: "Observe, calcule et décide. Chaque étape te rapproche du but. Objectif : Anglais — Éveil oral A1.",
          caption: "Les zones du terrain s’allument.",
        },
        rugby: {
          title: "Observe la défense",
          statement: "Lis les espaces, calcule, puis avance au bon moment. Objectif : Anglais — Éveil oral A1.",
          caption: "Les couloirs gauche, axe et large deviennent visibles.",
        },
        equitation: {
          title: "Choisis le chemin",
          statement: "Observe les bornes, calcule, et garde une allure sûre. Objectif : Anglais — Éveil oral A1.",
          caption: "Les principaux sentiers s’activent.",
        },
        espace: {
          title: "Rétablis la trajectoire",
          statement: "Analyse les signaux, calcule, et prépare l’arrimage. Objectif : Anglais — Éveil oral A1.",
    ...
    },
    {
      ...
      progress: 6,
      copy: allUniverses({
        title: "Je progresse sur : Anglais — Éveil oral A1",
    ...
    },
    {
      ...
      copy: allUniverses({
        title: "Ton bilan",
        statement: "Tu as travaillé « Anglais — Éveil oral A1 » sans note ni classement. Qu’as-tu réussi aujourd’hui ?",
