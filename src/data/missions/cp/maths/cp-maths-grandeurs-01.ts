...
export const MISSION_ID = "cp-maths-grandeurs-01";

/** CP / maths — Longueurs monnaie heure entière. Phase A standard. */
  ...
  steps: [
    {
      ...
      progress: 0,
      copy: allUniverses({
        title: "Bienvenue : Longueurs monnaie heure entière",
        statement: "Dans cette mission de CP, tu vas travailler : Longueurs monnaie heure entière. Lis bien chaque consigne, utilise l’indice si besoin, puis valide.",
    ...
    },
    {
      ...
      copy: {
        football: {
          title: "Lis le jeu",
          statement: "Observe, calcule et décide. Chaque étape te rapproche du but. Objectif : Longueurs monnaie heure entière.",
          caption: "Les zones du terrain s’allument.",
        },
        rugby: {
          title: "Observe la défense",
          statement: "Lis les espaces, calcule, puis avance au bon moment. Objectif : Longueurs monnaie heure entière.",
          caption: "Les couloirs gauche, axe et large deviennent visibles.",
        },
        equitation: {
          title: "Choisis le chemin",
          statement: "Observe les bornes, calcule, et garde une allure sûre. Objectif : Longueurs monnaie heure entière.",
          caption: "Les principaux sentiers s’activent.",
        },
        espace: {
          title: "Rétablis la trajectoire",
          statement: "Analyse les signaux, calcule, et prépare l’arrimage. Objectif : Longueurs monnaie heure entière.",
    ...
    },
    {
      ...
      progress: 6,
      copy: allUniverses({
        title: "Je progresse sur : Longueurs monnaie heure entière",
    ...
    },
    {
      ...
      copy: allUniverses({
        title: "Ton bilan",
        statement: "Tu as travaillé « Longueurs monnaie heure entière » sans note ni classement. Qu’as-tu réussi aujourd’hui ?",
