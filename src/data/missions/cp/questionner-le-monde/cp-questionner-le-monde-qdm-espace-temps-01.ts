...
export const MISSION_ID = "cp-questionner-le-monde-qdm-espace-temps-01";

/** CP / questionner-le-monde — Questionner le monde — Espace et temps. Phase A standard. */
export const mission = defineMission({
  id: MISSION_ID,
  grade: "cp",
  subject: "questionner-le-monde",
  title: "Espace et temps en mission",
  blurb: "Une mission CP : Questionner le monde — Espace et temps.",
  available: true,
  version: 1,
  steps: [
    {
      ...
      copy: allUniverses({
        ...
        statement: "Dans cette mission de CP, tu vas travailler : Questionner le monde — Espace et temps. Lis bien chaque consigne, utilise l’indice si besoin, puis valide.",
