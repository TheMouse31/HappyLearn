...
export const MISSION_ID = "cp-emc-vivre-ensemble-01";

/** CP / emc — EMC — Émotions règles coopération. Phase A standard. */
export const mission = defineMission({
  id: MISSION_ID,
  grade: "cp",
  subject: "emc",
  title: "Émotions règles coopération en mission",
  blurb: "Une mission CP : EMC — Émotions règles coopération.",
  available: false,
  version: 1,
  steps: [
    {
      ...
      progress: 0,
      copy: allUniverses({
        title: "Bienvenue : EMC — Émotions règles coopération",
        statement: "Dans cette mission de CP, tu vas travailler : EMC — Émotions règles coopération. Lis bien chaque consigne, utilise l’indice si besoin, puis valide.",
    ...
    },
    {
      ...
      copy: {
        football: {
          title: "Lis le jeu",
          statement: "Observe, calcule et décide. Chaque étape te rapproche du but. Objectif : EMC — Émotions règles coopération.",
          caption: "Les zones du terrain s’allument.",
        },
        rugby: {
          title: "Observe la défense",
          statement: "Lis les espaces, calcule, puis avance au bon moment. Objectif : EMC — Émotions règles coopération.",
          caption: "Les couloirs gauche, axe et large deviennent visibles.",
        },
        equitation: {
          title: "Choisis le chemin",
          statement: "Observe les bornes, calcule, et garde une allure sûre. Objectif : EMC — Émotions règles coopération.",
          caption: "Les principaux sentiers s’activent.",
        },
        espace: {
          title: "Rétablis la trajectoire",
          statement: "Analyse les signaux, calcule, et prépare l’arrimage. Objectif : EMC — Émotions règles coopération.",
    ...
    },
    {
      ...
      progress: 6,
      copy: allUniverses({
        title: "Je progresse sur : EMC — Émotions règles coopération",
    ...
    },
    {
      ...
      copy: allUniverses({
        title: "Ton bilan",
        statement: "Tu as travaillé « EMC — Émotions règles coopération » sans note ni classement. Qu’as-tu réussi aujourd’hui ?",
