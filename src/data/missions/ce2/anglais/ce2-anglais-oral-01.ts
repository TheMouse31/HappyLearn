...
export const MISSION_ID = "ce2-anglais-oral-01";

/** CE2 / anglais — Anglais — Oral A1. Phase A standard. */
export const mission = defineMission({
  id: MISSION_ID,
  grade: "ce2",
  subject: "anglais",
  title: "Oral A1 en mission",
  blurb: "Une mission CE2 : Anglais — Oral A1.",
  available: false,
  version: 1,
  steps: [
    {
      ...
      copy: allUniverses({
        ...
        statement: "Dans cette mission de CE2, tu vas travailler : Anglais — Oral A1. Lis bien chaque consigne, utilise l’indice si besoin, puis valide.",
