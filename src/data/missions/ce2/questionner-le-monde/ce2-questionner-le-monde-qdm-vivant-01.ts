...
export const MISSION_ID = "ce2-questionner-le-monde-qdm-vivant-01";

/** CE2 / questionner-le-monde — Questionner le monde — Vivant. Phase A standard. */
export const mission = defineMission({
  id: MISSION_ID,
  grade: "ce2",
  subject: "questionner-le-monde",
  title: "Vivant en mission",
  blurb: "Une mission CE2 : Questionner le monde — Vivant.",
  available: true,
  version: 1,
  steps: [
    {
      ...
      progress: 0,
      copy: allUniverses({
        title: "Bienvenue : Questionner le monde — Vivant",
        statement: "Dans cette mission de CE2, tu vas travailler : Questionner le monde — Vivant. Lis bien chaque consigne, utilise l’indice si besoin, puis valide.",
    ...
    },
    {
      ...
      copy: {
        football: {
          title: "Lis le jeu",
          statement: "Observe, calcule et décide. Chaque étape te rapproche du but. Objectif : Questionner le monde — Vivant.",
          caption: "Les zones du terrain s’allument.",
        },
        rugby: {
          title: "Observe la défense",
          statement: "Lis les espaces, calcule, puis avance au bon moment. Objectif : Questionner le monde — Vivant.",
          caption: "Les couloirs gauche, axe et large deviennent visibles.",
        },
        equitation: {
          title: "Choisis le chemin",
          statement: "Observe les bornes, calcule, et garde une allure sûre. Objectif : Questionner le monde — Vivant.",
          caption: "Les principaux sentiers s’activent.",
        },
        espace: {
          title: "Rétablis la trajectoire",
          statement: "Analyse les signaux, calcule, et prépare l’arrimage. Objectif : Questionner le monde — Vivant.",
    ...
    },
    {
      ...
      progress: 6,
      copy: allUniverses({
        title: "Je progresse sur : Questionner le monde — Vivant",
    ...
    },
    {
      ...
      copy: allUniverses({
        title: "Ton bilan",
        statement: "Tu as travaillé « Questionner le monde — Vivant » sans note ni classement. Qu’as-tu réussi aujourd’hui ?",
