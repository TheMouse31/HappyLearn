...
export const MISSION_ID = "ce2-emc-vivre-ensemble-01";

/** CE2 / emc — EMC — Vivre ensemble. Phase A standard. */
export const mission = defineMission({
  id: MISSION_ID,
  grade: "ce2",
  subject: "emc",
  title: "Vivre ensemble en mission",
  blurb: "Une mission CE2 : EMC — Vivre ensemble.",
  available: false,
  version: 1,
  steps: [
    {
      ...
      copy: allUniverses({
        ...
        statement: "Dans cette mission de CE2, tu vas travailler : EMC — Vivre ensemble. Lis bien chaque consigne, utilise l’indice si besoin, puis valide.",
