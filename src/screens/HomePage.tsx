      ...
      <section className="home-hero">
        <div className="home-hero-copy">
          ...
          <p className="lead" data-listen>
            Du CP au CM2, toutes les matières. Les élèves progressent avec Néo dans une aventure. Les professeurs et
            parents suivent la classe, sans note ni classement.
          </p>
          {continueTo ? (
      ...
      <section className="home-how" id="comment-ca-marche">
        ...
        <ol className="how-steps">
          <li>
            ...
            <span>Élève avec un prénom, ou professeur / parent avec un e-mail.</span>
          </li>
          <li>
